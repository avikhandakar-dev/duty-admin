...
import { getAllCancelledWithdrawRequest } from "@lib/api";
...
const CancelledWithdrawTable = () => {
  ...
  const fetchData = async () => {
    try {
      setIsFiltering(true);
      const { data } = await getAllCancelledWithdrawRequest(
        limit,
        skip,
        searchTerm
      );
...
export default CancelledWithdrawTable;
