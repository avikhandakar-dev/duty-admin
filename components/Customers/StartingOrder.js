...
import { getOrdersByServiceId, getOrdersByUserId } from "@lib/api";
...
import OrderDetailsModal from "@components/Vendors/OrderDetailsModal";

const StartingOrder = ({ status }) => {
