...
import SupportView from "@components/Vendors/SupportView";
import { getSupportByServiceId, getSupportsByUserId } from "@lib/api";
...
const SupportsChat = () => {
  ...
  const getSupports = async () => {
    ...
    try {
      setIsLoading(true);
      const { data } = await getSupportsByUserId(id, limit, skip);
